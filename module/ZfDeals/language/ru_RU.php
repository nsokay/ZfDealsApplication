...
return array(
    ...
    "Page not found." => "aaaaaaaaaaaaaaaaaaaaa",

    // Admin Layout
    "ZfDeals - Administration" => "ZfDeals - Администрирование",
    "Home" => "Главная",
    ...
    "Deals" => "Акции",
    "Add Deal" => "Добавить акцию",
    "Show active Deals" => "Показать текущие акции",

    // Site Layout
    "ZfDeals" => "ZfDeals",

    // Product Add Error
    "Product could not be added." => "Товар не может быть добавлен.",
    "Product added!" => "Товар добавлен!",

    // Product Fieldset
    "Product-ID" => "ID товара",
    "Product label" => "Название товара",
    "Trading stock" => "Количество",
